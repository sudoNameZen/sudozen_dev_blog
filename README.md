# Blog website for Nitin Dewangan SudoZen domain has been created as name sudozen.me as blog 

### creating the blog using next.js typescript zustand yml 
#### and doing so to create an SEO optimization with my portfolio also in the future problems 
